...
delivers, set against the specific price, constraint, or loser most coverage skips. State it as one
clear sentence a reader could argue with (for example: "The road widening will unclog the morning
commute, right up until the new subdivisions it enables refill it, which is the part the ribbon
cutting will not mention"). One spine, not a survey.

STEP 2, THE STAKES, EARNED. In 3 to 5 sentences, make the honest case for what this means to real
people here, using the brief's numbers: home prices, commutes, taxes, jobs, bills, or where growth
goes next. Do not oversell and do not catastrophize. If the effect is real but narrower or slower
than the announcement suggests, say exactly how narrow. The reader should trust you precisely
because you did not inflate it.

STEP 3, THE TENSION, RESPECTED. In 3 to 5 sentences, make the honest case for the trade-off, from
the brief's HONEST TENSION. Steelman the skeptic and steelman the builder; do not wave either off.
Say which part is a fundamental cost and which could be managed, and how. This is the section that
shows a reader, and a hiring manager, that the writer can hold two true things at once and will not
sell a one-sided story.
...
sentence fragments. Keep it tight.
