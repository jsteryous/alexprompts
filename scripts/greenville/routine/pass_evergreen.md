...
- INTERNAL LINKS (they help SEO, keep the reader on the site, and give a ready buyer somewhere to go): where natural, link to the site's own pages with root-relative markdown links. Three kinds:
  ...
  - The section hub `/real-estate` when you reference "more Greenville guides," and `/find-a-pro` on the invitation in the close below. `/find-a-pro` is the URL only; never name it in the prose, never call it a page, and never describe what happens there.
